...
export default function TabelaUsuarios(props) {
    ...
    { "id": "4", "nome": "Carlos Menezes dos Santos", "tipo": "Hospede", "email": "menezes.carlosms@gmail.com" }];
    ...
    function BotãoEstilo(variavel) {
        ...
        else if (variavel === "Hospede") {
            return <Button size="sm" variant="primary">Hospede</Button>
        }
    }
